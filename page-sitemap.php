		...
		<div class="entry-content sitemap-content">
			<section class="sitemap-section" aria-labelledby="sitemap-main-heading">
				...
				<ul class="sitemap-list">
					...
					<li><a href="<?php echo esc_url( function_exists( 'della_theme_consultation_url' ) ? della_theme_consultation_url() : 'https://수원성범죄전문변호사.kr/' ); ?>"><?php esc_html_e( '상담 신청', 'della-theme' ); ?></a></li>
